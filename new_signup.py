...
def signal_handler(signum, frame):
    ...
    if _translator:
        ...
        print("\nNhan duoc tin hieu thoat, dang dong...")
                ...
                if verification_code:
                    ...
                    if handle_turnstile(browser_tab, config, translator):
                        ...
                        if translator:
                            ...
                            print("Lan xac thuc cuoi cung that bai")
                        return False, None
...
def handle_sign_in(browser_tab, email, password, translator=None):
    ...
    try:
        ...
        print(f"{Fore.CYAN}Phat hien trang dang nhap, bat dau dang nhap...{Style.RESET_ALL}")
