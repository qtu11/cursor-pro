...
import sys
import json
from DrissionPage import ChromiumPage, ChromiumOptions  # pyright: ignore[reportMissingImports]
...
class OAuthHandler:
    ...
    def setup_browser(self):
        ...
        try:
            ...
            # Hien thi canh bao ve viec dong trinh duyet truoc - Su dung thong bao dong
            if self.translator:
    ...
    def _kill_browser_processes(self):
        ...
        try:
            ...
            # Dinh nghia cac tien trinh can dong dua tren loai trinh duyet va nen tang
            browser_processes = {
                'chrome': {
            ...
            # Lay danh sach tien trinh can dong
            ...
            # Dong tien trinh dua tren nen tang
    ...
    def _get_user_data_directory(self):
        ...
        try:
            ...
            # Lay thu muc du lieu nguoi dung dua tren he dieu hanh va loai trinh duyet
            if os.name == 'nt':  # Windows
                user_data_dirs = {
            ...
            # Lay thu muc du lieu nguoi dung cua trinh duyet duoc chon, neu khong tim thay thi su dung Chrome
            ...
            if user_data_dir and os.path.exists(user_data_dir):
                ...
                return user_data_dirs['chrome']  # Quay lai thu muc Chrome
            ...
            # Cung cap mot thu muc mac dinh khi co loi
            if os.name == 'nt':
    ...
    def _get_browser_path(self):
        ...
        try:
            ...
            # Truoc tien kiem tra xem co duong dan trinh duyet duoc chi dinh ro rang trong cau hinh khong
            ...
            # Neu khong tim thay trinh duyet duoc chi dinh trong cau hinh, thi thu tim cac trinh duyet tuong thich khac
            if os.name == 'nt':  # Windows
                possible_paths = []
                ...
                if browser_type == 'brave':
                    ...
                    possible_paths = [
                        '/usr/bin/google-chrome-stable',  # Uu tien kiem tra google-chrome-stable
                        '/usr/bin/google-chrome',
                        '/usr/bin/chromium',
                        '/usr/bin/chromium-browser'
                    ]
                
            # Kiem tra tung duong dan co the
            ...
            # Neu khong tim thay trinh duyet chi dinh, thi thu su dung Chrome
    ...
    def _configure_browser_options(self, browser_path, user_data_dir, active_profile):
        ...
        try:
            ...
            co.set_argument('--remote-debugging-port=9222')  # Chi dinh ro rang cong debug
        ...
        try:
            ...
            try:
                ...
                if "accounts.google.com" in self.browser.url:
                    ...
                    # Lay xem co bat tuy chon alert trong cau hinh khong
                    config = get_config(self.translator)
